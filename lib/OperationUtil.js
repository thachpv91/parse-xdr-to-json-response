...
const OPERATION_STRING_TO_INT = {
    ...
    limitAsset: OPERATION_TYPE.LIMIT_ASSET,
    changeAsset: OPERATION_TYPE.CHANGE_ASSET,
    createAsset: OPERATION_TYPE.CREATE_ASSET
};
...
const OPERATION_CAMEL_TO_LOWER = {
    ...
    limitAsset: 'limit_asset',
    changeAsset: 'change_asset',
