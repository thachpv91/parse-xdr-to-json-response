...
const CreatePassiveOfferResponse = function (operation, tx) {
    const {
        type,
        source,
        selling,
    ...
    return {
        ...
        buying_asset_code: buying.issuer ? buying.code : 'RIA',
        ...
        selling_asset_code:  selling.issuer ? selling.code : 'RIA',
        selling_asset_issuer: selling.issuer
    };
};
module.exports = CreatePassiveOfferResponse;
